...
You can check how web app looks like [here](http://165.232.125.83:8079). Though you wouldn't be able see opened positions on exchange site(for this launch app with your own API keys), it should give you idea how does app look like and what it can do
